...
class ResumenesDocente(db.Base):
    __tablename__ = 'resumenes_docente'
    ...
    def attributes_setter(self, values):
        for attribute in values.keys():
            setattr(self, attribute, values[attribute])
...
class ResumenesEstudiante(db.Base):
    __tablename__ = 'resumenes_estudiante'
